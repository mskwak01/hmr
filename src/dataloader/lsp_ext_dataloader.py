...
sys.path.append('/home/ubuntu/anaconda3/envs/hmr/pytorch_HMR/src/')
...
if __name__ == '__main__':
    lsp = LspExtLoader('/home/ubuntu/anaconda3/envs/hmr/pytorch_HMR/data/lsp_ext', True, [1.05, 1.5], False, flip_prob = 1.0)
    l = lsp.__len__()
